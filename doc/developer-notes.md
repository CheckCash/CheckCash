...
CheckCash Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as CheckCash Core, where everyone uses
...
pay attention to for reviewers of CheckCash Core code.

General CheckCash Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CheckCash Core uses tinyformat, which is type safe. Leave them out to avoid confusion
