...
This mechanism has been integrated into Bitcore-Node-CheckCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/checkcashpay/insight-api-checkcash#web-socket-api](https://github.com/checkcashpay/insight-api-checkcash#web-socket-api)
* API: [https://github.com/checkcashpay/insight-api-checkcash#instantsend-transactions](https://github.com/checkcashpay/insight-api-checkcash#instantsend-transactions)
...
By default, the CheckCash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CheckCash Core daemon:
