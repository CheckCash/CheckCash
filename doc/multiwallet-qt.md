...
Only requiring some minor changes is checkcash.cpp.
...
Changes to checkcash.cpp
----------------------
checkcash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
