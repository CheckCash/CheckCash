...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CheckCash Core checkcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  checkcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded checkcash transaction") + "\n" +
              "  checkcash-tx [options] -create [commands]   " + _("Create hex-encoded checkcash transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded checkcash transaction
