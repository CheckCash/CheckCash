 ...
 *
 *   // network
 *   CCheckCashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.checkcash.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCheckCashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCheckCashNetwork(UniValue objIn)
    {
...
// // can be under: CheckCashNetwork
// //   -- signature requirements : Key1(User)
// class CCheckCashNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CheckCashNetwork);
//     // }
