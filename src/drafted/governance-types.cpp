...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CheckCashNetwork") type = CheckCashNetwork;
    if(strType == "CheckCashNetworkVariable") type = CheckCashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CheckCashNetwork) s = "CheckCashNetwork";
    if(type == CheckCashNetworkVariable) s = "CheckCashNetworkVariable";
