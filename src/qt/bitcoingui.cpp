    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CheckCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CheckCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and checkcash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CheckCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about CheckCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CheckCash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CheckCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CheckCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a checkcash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CheckCash Core help message to get a list with possible CheckCash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CheckCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CheckCash network", "", count));
    } else {
...
{
    QString strTitle = tr("CheckCash Core"); // default title
    ...
    // Append title to "CheckCash Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
