    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CKH-light"), QVariant("light"));
    ui->theme->addItem(QString("CKH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CKH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CKH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CKH-traditional"), QVariant("trad"));
