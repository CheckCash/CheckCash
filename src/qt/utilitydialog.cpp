    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CheckCash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CheckCash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  checkcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CheckCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CKH, 0.1 CKH, 1 CKH and 10 CKH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://checkcashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://checkcashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CheckCash Core is shutting down...") + "<br /><br />" +
