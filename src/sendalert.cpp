...
2. run checkcashd with -printalert or -sendalert like this:
   /path/to/checkcashd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.checkcash.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CheckCash Core:0.12.0.58/"));
