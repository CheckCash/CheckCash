...
#define BOOST_TEST_MODULE CheckCash Test Suite

#include "test_checkcash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_checkcash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
